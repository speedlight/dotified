...
vicious.register(netwidget, vicious.widgets.net, '<span font="Signika 14" rise="2000"> <span font="Signika 10" color="#7AC82E">${eth0 down_kb}</span> <span font="Signika 7" color="#EEDDDD">↓↑</span> <span font="Signika 10" color="#46A8C3">${eth0 up_kb} </span></span>', 3)
vicious.register(netwidget, vicious.widgets.net, '<span background="#313131" font="Terminus 13" rise="2000"> <span font="Terminus 9" color="#7AC82E">${eth3 down_kb}</span> <span font="Terminus 7" color="#EEDDDD">↓↑</span> <span font="Terminus 9" color="#46A8C3">${eth3 up_kb} </span></span>', 3)
